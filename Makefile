...
#     ABSTRACT => q[A glipmse at an Englightened Perl.]
#     AUTHOR => q[Chris Prather <chris@prahter.org>]
#     DIR => []
#     DISTNAME => q[Task-Kensho]
#     NAME => q[Task::Kensho]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { ExtUtils::MakeMaker=>q[6.44] }
#     VERSION => q[0.0.6]
...
# These definitions are from config.sh (via /usr/local/perl/lib/5.10.0/darwin-2level/Config.pm).
...
OSVERS = 9.5.0
RANLIB = ranlib
SITELIBEXP = /usr/local/perl/lib/site_perl/5.10.0
SITEARCHEXP = /usr/local/perl/lib/site_perl/5.10.0/darwin-2level
SO = dylib
VENDORARCHEXP = 
VENDORLIBEXP = 
...
PERL_LIB =
PERL_ARCHLIB = /usr/local/perl/lib/5.10.0/darwin-2level
LIBPERL_A = libperl.a
FIRST_MAKEFILE = Makefile
MAKEFILE_OLD = Makefile.old
MAKE_APERL_FILE = Makefile.aperl
PERLMAINCC = $(CC)
PERL_INC = /usr/local/perl/lib/5.10.0/darwin-2level/CORE
...
MAKEMAKER   = /usr/local/perl/lib/5.10.0/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.44
MM_REVISION = 54639
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Task/Kensho.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Task
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Task
...
TO_INST_PM = lib/Task/Kensho.pm

PM_TO_BLIB = lib/Task/Kensho.pm \
	blib/lib/Task/Kensho.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Task/Kensho.pm $(INST_MAN3DIR)/Task::Kensho.$(MAN3EXT) 
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0,0,6,0">' > $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Task/Kensho.pm blib/lib/Task/Kensho.pm 
