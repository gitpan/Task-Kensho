...
{
  $Task::Kensho::Hackery::VERSION = '0.34'; # TRIAL
}
...
installable whippitupitude These packages are included less for production
work and more whippitupitude. They reflect that people have found
incredibly useful prototyping debugging before reducing down to a script.
...
=head1 SYNOPSIS
    ...
    > cpanm --verbose Task::Kensho::Hackery
